...
import { fetchCount } from "../../api/admin-api.js";

const Count = () => {
  const { count, isCountLoading } = useSelector((state) => state.admin);

  const items = [
    {
      title: "Total Users",
      num: count?.totalUsers ?? 0,
      icon: <PiUsersThree />,
      color: "from-blue-500 to-blue-600",
    },
    {
      title: "Total Buyers",
      num: count?.totalBuyers ?? 0,
      icon: <FaPeopleGroup />,
      color: "from-amber-500 to-amber-600",
    },
    {
      title: "Total Seller",
      num: count?.totalSellers ?? 0,
